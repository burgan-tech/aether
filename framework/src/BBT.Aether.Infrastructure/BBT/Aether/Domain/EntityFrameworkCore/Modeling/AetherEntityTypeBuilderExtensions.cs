...
public static class AetherEntityTypeBuilderExtensions
{
    ...
    public static void TryConfigureDeletionAudited(this EntityTypeBuilder b)
    {
        if (b.Metadata.ClrType.IsAssignableTo<IDeletionAuditedObject>())
        {
            ...
            b.Property(nameof(IDeletionAuditedObject.DeletedBy))
                .IsRequired(false)
                .HasMaxLength(AuditedEntityConsts.Length)
                .HasColumnName(nameof(IDeletionAuditedObject.DeletedBy));
        }
    }

    public static void ConfigureCreatedBy<T>(this EntityTypeBuilder<T> b)
        where T : class, ICreationAuditedObject
    {
        b.As<EntityTypeBuilder>().TryConfigureCreatedBy();
    }

    public static void TryConfigureCreatedBy(this EntityTypeBuilder b)
    {
        if (b.Metadata.ClrType.IsAssignableTo<ICreationAuditedObject>())
        {
            b.Property(nameof(ICreationAuditedObject.CreatedBy))
                .HasMaxLength(AuditedEntityConsts.Length)
                .HasColumnName(nameof(ICreationAuditedObject.CreatedBy));

            b.Property(nameof(ICreationAuditedObject.CreatedByBehalfOf))
                .HasMaxLength(AuditedEntityConsts.Length)
                .HasColumnName(nameof(ICreationAuditedObject.CreatedByBehalfOf));
        }
    }
    ...
    public static void ConfigureModifiedBy<T>(this EntityTypeBuilder<T> b)
        where T : class, IModifyAuditedObject
    {
        b.As<EntityTypeBuilder>().TryConfigureModifiedBy();
    }

    public static void TryConfigureModifiedBy(this EntityTypeBuilder b)
    {
