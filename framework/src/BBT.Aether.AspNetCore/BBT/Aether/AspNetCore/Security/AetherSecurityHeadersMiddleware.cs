...
public sealed class AetherSecurityHeadersMiddleware(IOptions<AetherSecurityHeadersOptions> options) : IMiddleware
{
    public IOptions<AetherSecurityHeadersOptions> Options { get; set; } = options;
    ...
    public async Task InvokeAsync(HttpContext context, RequestDelegate next)
    {
        ...
        if (endpoint?.Metadata.GetMetadata<IgnoreAetherSecurityHeaderAttribute>() != null)
        {
        ...
        if (Options.Value.UseContentSecurityPolicyScriptNonce)
        {
            ...
            context.Items.Add(AetherAspNetCoreConsts.ScriptNonceKey, randomValue);
        }
    ...
    private string BuildContentSecurityPolicyValue(HttpContext context)
    {
        ...
        if (!(Options.Value.UseContentSecurityPolicyScriptNonce &&
              context.Items.TryGetValue(AetherAspNetCoreConsts.ScriptNonceKey, out var nonce) &&
