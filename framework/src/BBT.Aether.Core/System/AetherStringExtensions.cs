...
/// </summary>
public static class AetherStringExtensions
{
    /// <summary>
    ...
    /// <summary>
    /// Adds a char to beginning of given string if it does not start with the char.
    /// </summary>
    ...
    public static bool IsNullOrEmpty([Diagnostics.CodeAnalysis.NotNullWhen(false)]this string? str)
    {
    ...
    /// </summary>
    [ContractAnnotation("str:null => true")]
    public static bool IsNullOrWhiteSpace([Diagnostics.CodeAnalysis.NotNullWhen(false)]this string? str)
    {
    ...
    public static string LastCharacters(this string str, int numberOfCharacters)
    {
        numberOfCharacters = numberOfCharacters > str.Length ? str.Length : numberOfCharacters;

        return str.Substring(Math.Min(str.Length - numberOfCharacters, str.Length));
    }
    ...
    public static string ToEnglish(this string str)
    {
        ...
        var tchar = new[] { 'ç', 'Ç', 'ğ', 'Ğ', 'ı', 'İ', 'ö', 'Ö', 'ş', 'Ş', 'ü', 'Ü' };
        var echar = new[] { 'c', 'C', 'g', 'G', 'i', 'I', 'o', 'O', 's', 'S', 'u', 'U' };

        for (var i = 0; i < echar.Length; i++)
        {
            str = str.Replace(tchar[i], echar[i]);
        }
    ...
    public static string ToIpWithoutPort(this string ipAddress)
    {
        if (string.IsNullOrWhiteSpace(ipAddress))
        {
            return string.Empty;
        }
        var ipadress = ipAddress.Split(':').First(); 
        return ipadress.RemoveRight("%450");
    }
}
