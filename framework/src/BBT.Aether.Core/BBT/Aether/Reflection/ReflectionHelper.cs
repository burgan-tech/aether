...
namespace BBT.Aether.Reflection;
...
public static class ReflectionHelper
{
    ...
    /// <summary>
    /// Tries to get an of attribute defined for a class member, and it's declaring type including inherited attributes.
    ...
    /// <summary>
    /// Tries to get attributes defined for a class member, and it's declaring type including inherited attributes.
    /// </summary>
    /// <typeparam name="TAttribute">Type of the attribute</typeparam>
    /// <param name="memberInfo">MemberInfo</param>
    /// <param name="inherit">Inherit attribute from base classes</param>
    ...
    /// </summary>
    static internal void SetValueByPath(object obj, Type objectType, string propertyPath, object value)
    {
        var currentType = objectType;
