...
/// </summary>
public class AetherValidationException : AetherException,
    IHasLogLevel,
    ...
    IExceptionWithSelfLogging
{
    ...
    /// Constructor.
    /// </summary>
    public AetherValidationException()
    {
    ...
    public AetherValidationException(string message)
        : base(message)
    {
        ValidationErrors = new List<ValidationResult>();
        LogLevel = LogLevel.Warning;
    ...
    public AetherValidationException(IList<ValidationResult> validationErrors)
    {
    ...
    /// <param name="message">Exception message</param>
    /// <param name="validationErrors">Validation errors</param>
    public AetherValidationException(string message, IList<ValidationResult> validationErrors)
        : base(message)
    {
        ValidationErrors = validationErrors;
        LogLevel = LogLevel.Warning;
    ...
    public AetherValidationException(string message, Exception innerException)
